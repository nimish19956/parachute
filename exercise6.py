...
if __name__=='__main__':
    ...
    instances=["instance1", "instance2", "instance3", "instance4", "instance5"]
    for i in range(len(instances)):
        if i==0: instances[i] = Boeing_747(78,31,51,60)
        if i==1: instances[i] = Boeing_747(40,15,59,48)
        if i==2: instances[i] = Boeing_747(3,67,57,49)
        if i==3: instances[i] = Boeing_747(11,88,67,60)
        if i==4: instances[i] = Boeing_747(13,13,50,62)
